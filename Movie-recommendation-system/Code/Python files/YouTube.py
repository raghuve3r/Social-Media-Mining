...
CLIENT_SECRETS_FILE = "/home/suhas/client_secrets1.json"
                      #"/home/suhas/client_secrets.json"
...
def get_authenticated_service(args):
  ...
  with open("/home/suhas/youtube-v3-discoverydocument.json", "r") as f:
    doc = f.read()
...
if __name__ == "__main__":
  ...
  args = argparser.parse_args()
  youtube = get_authenticated_service(args)
  video_comment_threads = get_comment_threads(youtube, '6a6QhCLhhMs')
  parent_id = video_comment_threads[0]["id"]
  video_comments = get_comments(youtube, parent_id)